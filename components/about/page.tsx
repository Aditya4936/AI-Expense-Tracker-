...
const AboutPage = () => {
  return (
    <div className='font-sans bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20 text-gray-800 dark:text-gray-200 transition-all duration-300 min-h-screen'>
      {/* Hero Section */}
      <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-blue-500/10 via-sky-500/5 to-orange-500/10 dark:from-blue-900/30 dark:via-sky-900/20 dark:to-orange-900/30'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto w-full'>
          ...
          <div className='mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0'>
            <Link
              href='/sign-up'
              className='group relative overflow-hidden bg-gradient-to-r from-blue-600 via-sky-500 to-orange-500 hover:from-blue-700 hover:via-sky-600 hover:to-orange-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold shadow-2xl hover:shadow-3xl transition-all duration-200 transform hover:-translate-y-0.5'
            >
      ...
      <section className='py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden'>
        <div className='absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-sky-500 to-orange-500'></div>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <div className='mt-10 grid grid-cols-1 md:grid-cols-3 gap-6'>
            <div className='bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/20 p-6 rounded-2xl border border-blue-100 dark:border-blue-800/50'>
            ...
            <div className='bg-gradient-to-br from-sky-50 to-orange-50 dark:from-sky-900/20 dark:to-orange-900/20 p-6 rounded-2xl border border-sky-100 dark:border-sky-800/50'>
            ...
            <div className='bg-gradient-to-br from-orange-50 to-blue-50 dark:from-orange-900/20 dark:to-blue-900/20 p-6 rounded-2xl border border-orange-100 dark:border-orange-800/50'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              <div className='absolute inset-0 bg-gradient-to-br from-blue-500/5 to-sky-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-blue-500 via-sky-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              <div className='absolute inset-0 bg-gradient-to-br from-sky-500/5 to-orange-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-sky-500 via-orange-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'>✨</span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 dark:text-gray-100'>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              <div className='absolute inset-0 bg-gradient-to-br from-orange-500/5 to-blue-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-orange-500 via-blue-500 to-sky-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'>📊</span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 dark:text-gray-100'>
      ...
      <section className='py-20 px-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden'>
        <div className='absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-500/5 to-sky-500/5 rounded-full blur-2xl'></div>
        <div className='absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-orange-500/5 to-blue-500/5 rounded-full blur-2xl'></div>
        ...
        <div className='max-w-4xl mx-auto relative z-10'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              ...
              <div className='flex items-center gap-4 pt-4'>
                <div className='flex -space-x-2'>
                  <div className='w-10 h-10 bg-gradient-to-br from-blue-500 to-sky-500 rounded-full border-2 border-white dark:border-gray-800'></div>
                  <div className='w-10 h-10 bg-gradient-to-br from-sky-500 to-orange-500 rounded-full border-2 border-white dark:border-gray-800'></div>
                  <div className='w-10 h-10 bg-gradient-to-br from-orange-500 to-blue-500 rounded-full border-2 border-white dark:border-gray-800'></div>
                </div>
            ...
            <div className='bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/20 p-8 rounded-2xl border border-blue-100 dark:border-blue-800/50'>
              <div className='space-y-6'>
      ...
      <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20 relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center relative z-10'>
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
            <Link
              href='/sign-up'
              className='group relative overflow-hidden bg-gradient-to-r from-blue-600 via-sky-500 to-orange-500 hover:from-blue-700 hover:via-sky-600 hover:to-orange-600 text-white px-8 py-4 rounded-2xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-200 transform hover:-translate-y-0.5'
            >
