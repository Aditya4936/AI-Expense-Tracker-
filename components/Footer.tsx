        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
          ...
          <div className='text-center md:text-left'>
            <div className='inline-flex items-center gap-2 mb-4'>
              <div className='w-8 h-8 bg-gradient-to-br from-blue-500 via-sky-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg'>
                <span className='text-white text-lg'>💰</span>
              </div>
              <h2 className='text-xl font-bold bg-gradient-to-r from-blue-600 via-sky-500 to-orange-500 bg-clip-text text-transparent'>
                ExpenseTracker AI
              </h2>
            </div>
          ...
          <div className='text-center md:text-left'>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-gradient-to-br from-sky-500 to-orange-500 rounded-md flex items-center justify-center shadow-sm'>
                  <span className='text-white text-xs'>✨</span>
                </div>
                Smart Categorization
              </div>
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-gradient-to-br from-orange-500 to-blue-500 rounded-md flex items-center justify-center shadow-sm'>
                  <span className='text-white text-xs'>📊</span>
                </div>
                Analytics Dashboard
              </div>
