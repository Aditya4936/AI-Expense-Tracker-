      ...
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
        ...
        <div className='space-y-3 sm:space-y-4'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3'>
            ...
            {/* Lowest Expense */}
            <div className='bg-sky-50/80 dark:bg-sky-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-sky-500 hover:bg-sky-50 dark:hover:bg-sky-900/30'>
              <div className='flex items-center gap-2'>
                <div className='w-6 h-6 bg-sky-100 dark:bg-sky-800 rounded-xl flex items-center justify-center flex-shrink-0'>
                  <span className='text-sm leading-none text-sky-600 dark:text-sky-300 font-bold'>
                    ↓
                  </span>
                </div>
                <div className='flex-1'>
    ...
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
        <div className='flex items-center gap-3 mb-6'>
          <div className='w-12 h-12 bg-gradient-to-br from-blue-500 via-sky-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg'>
